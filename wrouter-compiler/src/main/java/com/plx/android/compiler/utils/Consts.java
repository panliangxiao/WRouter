...
public class Consts {
    ...
    public static final String PROJECT = "WRouter";
    public static final String TAG = PROJECT + "::";
    public static final String WARNING_TIPS = "DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY WROUTER.";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.plx.android.wrouter.routes";
    public static final String PACKAGE_OF_GENERATE_DOCS = "com.plx.android.wrouter.docs";
    ...
    // Custom interface
    private static final String FACADE_PACKAGE = "com.plx.android.wrouter.facade";
    ...
    public static final String NO_MODULE_NAME_TIPS = "These no module name, at 'build.gradle', like :\n" +
            ...
            "                arguments = [WROUTER_MODULE_NAME: project.getName()]\n" +
            "            }\n" +
            "        }\n" +
            "    }\n" +
            "}\n";
    ...
    public static final String KEY_MODULE_NAME = "WROUTER_MODULE_NAME";
    public static final String KEY_GENERATE_DOC_NAME = "WROUTER_GENERATE_DOC";
