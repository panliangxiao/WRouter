...
/**
 * Scan all class in the package: com/plx/android/wrouter/
        ...
        if (jarFile) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if (entryName.startsWith(ScanSetting.ROUTER_CLASS_PACKAGE_NAME)) {
                    ...
                    Logger.i('dest file ' + destFile.absolutePath + ' found')
                }
            }
            Logger.i(file.name + ' end...<<<')
            file.close()
        }
    }
                ...
                if (ext.interfaceName && interfaces != null) {
                    interfaces.each { itName ->
                        if (itName == ext.interfaceName) {
                            ...
                            Logger.i('ScanClassVisitor find : ' + name + ' <<<')
                        }
                    }
                }
            }
