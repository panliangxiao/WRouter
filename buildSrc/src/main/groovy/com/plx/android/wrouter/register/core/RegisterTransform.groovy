package com.plx.android.wrouter.register.core;

import com.android.build.api.transform.*
import com.android.build.gradle.internal.pipeline.TransformManager
import com.plx.android.wrouter.register.utils.Logger
import com.plx.android.wrouter.register.utils.ScanSetting
import com.plx.android.wrouter.register.utils.ScanUtil
    ...
    void transform(Context context, Collection<TransformInput> inputs
        ...
        inputs.each { TransformInput input ->
            ...
            input.jarInputs.each { JarInput jarInput ->
                Logger.i(jarInput.file.absolutePath + ' start <<<')
                ...
                Logger.i(jarInput.file.absolutePath + ' end <<<')
            }
            // scan class files
            input.directoryInputs.each { DirectoryInput directoryInput ->
                Logger.i(directoryInput.file.absolutePath + ' start <<<')
                ...
                Logger.i(directoryInput.file.absolutePath + ' end <<<')
            }
        }
